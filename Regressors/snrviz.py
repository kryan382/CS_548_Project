...
ax.set_xlabel('Phase Noise', fontsize = 12, fontweight = 'bold')
ax.set_ylabel('Symbol Rate', fontsize = 12, fontweight = 'bold')
ax.set_zlabel('BER', fontsize = 12, fontweight = 'bold')
print("labels")
cbar = plt.colorbar(sc, pad=0.02, orientation='horizontal', shrink=0.4)
cbar.set_label('SNR', fontsize = 12, fontweight = 'bold')
